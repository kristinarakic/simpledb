...
public class SortScan implements Scan{
   ...
   //private int savedCurrent = 0; // 0 none, 1 = s1, 2 = s2
   ...
   public void restorePosition() {
      ...
      /*
      *
      *   // Reset merge state so next() recomputes correctly
          currentscan = null;

          // Conservative: assume both still have current record available.
          // We'll let next() pick currentscan without advancing anyone incorrectly.
          hasmore1 = true;
